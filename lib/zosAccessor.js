...
ZosAccessor.prototype.listJobs = function (jobNameOrOption) {
    ...
    if (typeof jobNameOrOption === 'string' || jobNameOrOption === undefined) {
        ...
        option = {jobName: jobNameOrOption || '*', owner: this.username, status: '*'};
        ...
        option.status = jobNameOrOption.status || '*';
    ...
    ftpClient.ascii(function (err) {
        ...
        // Issue command like "site FILETYPE=JES JESJOBNAME=H* JESOWNER=* JESSTATUS=*"
